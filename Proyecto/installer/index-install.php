          ...
          <div class="wrap d-md-flex">
            ...
            <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
              <div class="text w-100">
                <h2>Bienvenido a la página de instalación</h2>
              </div>
            </div>
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <div class="d-flex">
                <div class="w-100">
                  <h3 class="mb-4" style="font-weight: bold;">Instalar</h3>
                </div>
                <div class="w-100">
                ...
                <form action="instalador.php" method="post">
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="correo" name="usuariodb">
                  </div>

                  <div class="form-group mb-3">
                    <label class="label" for="correo">Contraseña</label>
                    <input type="text" class="form-control" id="correo" name="contrasenadb">
                  </div>

                  <div class="form-group mb-3">
                    <label class="label" for="correo">Base de datos</label>
                    <input type="text" class="form-control" id="correo" name="db">
                  </div>
