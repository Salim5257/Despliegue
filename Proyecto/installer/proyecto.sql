...
-- Tiempo de generación: 17-06-2022 a las 14:20:44
...
ALTER TABLE `carrito`
  ...
  ADD CONSTRAINT `carrito_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
