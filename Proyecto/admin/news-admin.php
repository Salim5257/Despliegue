...
if ($connection) {
  ...
  <body>
    ...
    <header>
      <div class="header-1">
        ...
        <div class="form-container">
          <form action="../app/search-php/search-news.php">
            <input type="search" placeholder="Buscar" id="searchNews">
            <label for="searchNews" class="fas fa-search"><span style="color:transparent;">ˍ</span></label>
          </form>
          <div id="resultado">
            <div>
              <ul id="contenedor"></ul>
      ...
      <div class="header-2">
        ...
        <nav class="navbar">
          <ul>
            ...
            <li><a class="active" href="../admin/news-admin.php">Novedades</a></li>
    ...
    <div class="p-4" id="border-admin">
      ...
      <h1><b>Lista de novedades</b> <a href="print/news-print-excel.php" id="print-excel-admin">Excel <i class="fa-solid fa-file-excel"></i></a> <a href="print/news-print-pdf.php" id="print-pdf-admin">PDF <i class="fa-solid fa-file-pdf"></i></a></h1><br>
