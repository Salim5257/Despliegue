    ...
    <header>
      <div class="header-1">
        ...
        <div class="form-container">
          <form action="../app/search-php/search-prod.php">
            <input type="search" placeholder="Buscar" id="searchProd">
            <label for="searchProd" class="fas fa-search"><span style="color:transparent;">ˍ</span></label>
          </form>
          <div id="resultado">
            <div>
              <ul id="contenedor"></ul>
