...
if ($connection) {
    ...
    /* Lista de cabeceras que me permiten crear una hoja excel para la lista de contactos */

    header("Content-type: application/vnd.ms-excel");
    header("Content-Disposition: attachment;filename='contact-print-excel.xls'");
    header("Expires: 0");
