<?php
    ...
    /* Lista de cabeceras que me permiten crear una hoja excel para la lista de productos */

    header("Content-type: application/vnd.ms-excel");
    header("Content-Disposition: attachment;filename='product-print-excel.xls'");
    header("Expires: 0");
    header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
    header("Pragma: public");

    /* Recojo los datos de producto y los guardo en mi base de datos */
