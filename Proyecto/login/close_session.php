          ...
          <div class="wrap d-md-flex">
            ...
            <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
              <div class="text w-100">
                <h2>Bienvenido a la página de cierre de sesión</h2>
              </div>
            </div>
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <div class="d-flex">
                ...
                <div class="form-group">
                    <a href="login.php"><button type="submit" class="btn btn-primary w-100 submit">Volver al inicio de sesión</button></a>
                </div>
