          ...
          <div class="wrap d-md-flex">
            ...
            <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
              <div class="text w-100">
                <h2>Bienvenido a la página comprobación de usuario</h2>
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <div class="d-flex">
                ...
                <div class="form-group mb-3">
                    <h3>El correo electrónico o el dni introducido ya existe</h3>
                </div>

                <br>

                <div class="form-group">
                    <a href="registro.php"><button type="submit" class="btn btn-primary w-100 submit">Volver al registro</button></a>
                </div>
