          ...
          <div class="wrap d-md-flex">
            ...
            <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
              <div class="text w-100">
                <h2>Bienvenido a la página de inicio de sesión</h2>
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <div class="d-flex">
                <div class="w-100">
                  <h3 class="mb-4">Inicie sesión</h3>
                </div>
                <div class="w-100">
              ...
              <form action="../app/login-check.php" method="post" class="signin-form needs-validation" novalidate>

                <div class="form-group mb-3">
                  <label class="label" for="correo">Correo electrónico</label>
                  <input type="text" class="form-control" id="correo" name="correo" placeholder="ejemplo@hotmail.com" required maxlength="30" pattern="[a-zA-Z0-9_.]+@+[a-zA-Z]+.[a-z]{1,30}">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="password" class="form-control" id="contrasena" name="contrasena" placeholder="deberá comprender entre 7-20 caracteres" required maxlength="20" pattern="[A-Za-z0-9!_.?$]{7,20}">
                  <div class="valid-feedback">Campo OK</div>
                  <div class="invalid-feedback">Introduzca su contraseña</div>
                </div>

                <div class="form-group">
                  <button type="submit" class="btn btn-primary w-100 submit">Enviar</button>
                </div>
              ...
              <form action="../app/login-check.php" method="post">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-success w-100 submit">Entrar como invitado</button>
                </div>
              </form>
