        ...
        <div class="col-md-12 col-lg-10">
          <div class="wrap d-md-flex">
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <div class="d-flex">
                <div class="w-100">
                  <h3 class="mb-4" style="font-weight: bold;">Error</h3>
                </div>
                <div class="w-100">
                ...
                <div class="form-group mb-3">
                    <h3>El código introducido no es correcto</h3>
                </div>
                ...
                <form action="verificacion.php" method="post">
                    ...
                    <div class="form-group">
                        <a href="#"><button type="submit" class="btn btn-primary w-100 submit">Intentar de nuevo</button></a>
                    </div>
                </form>
