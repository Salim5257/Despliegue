...
if ($connection) {
    ...
    /* Se recojen los datos del producto */
    ...
    $query = "UPDATE producto SET producto_marca = '$producto_marca', producto_imagen = '$producto_imagen', producto_nombre = '$producto_nombre', producto_desc = '$producto_desc', 
    producto_precio = '$producto_precio' WHERE id = '$id'";
                            ...
                            <div class="wrap d-md-flex">
                                ...
                                <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                                    <div class="text w-100">
                                        <h2>Bienvenido a la página de edición de productos</h2>
                                    </div>
                                </div>
