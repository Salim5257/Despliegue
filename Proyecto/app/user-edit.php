...
if ($connection) {
    ...
    $query = "UPDATE usuario SET nombre = '$nombre', apellido = '$apellido', dni = '$dni', telefono = '$telefono', 
                            ...
                            <div class="wrap d-md-flex">
                                ...
                                <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                                    <div class="text w-100">
                                        <h2>Bienvenido a la página de edición de usuarios</h2>
                                    </div>
                                </div>
                                ...
                                <div class="login-wrap p-4 p-lg-5">
                                    ...
                                    <div class="form-group">
                                        <a href="../admin/user-admin.php"><button type="submit" class="btn btn-primary w-100 submit">Volver a la página de administrador</button></a>
                                    </div>
                                    <br>
                                </div>
