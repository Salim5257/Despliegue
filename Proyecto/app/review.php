    ...
    <header>
        <div class="header-1">
            ...
            <div class="form-container">
                <form action="#">
                    <input type="search" placeholder="Buscar productos" id="searchIndex">
                    <label for="searchIndex" class="fas fa-search"><span style="color:transparent;">ˍ</span></label>
                </form>
            </div>
        </div>
        ...
        <div class="header-2">
            <nav class="navbar">
                <ul>
                    ...
                    <li><a class="active" href="../index.php#review">Reseñas</a></li>
            ...
            <div class="icons">
                ...
                <?php
                    ...
                    echo "<a href='../favoritos/favoritos.php' class='fas fa-heart' aria-label='like button'></a><a href='../carrito/cart.php' class='fas fa-shopping-cart' aria-label='cart button'></a>";
