<?php
    ...
    if (isset($_POST['reseña_nombre'])) {
        ...
        /* En caso de estar todos los campos, crea la reseña y la guarda en la base de datos */
        
        $query = "INSERT INTO reseña(reseña_comentario, reseña_nombre, reseña_imagen) VALUES 
        ('$reseña_comentario', '$reseña_nombre', '$reseña_imagen')";
